# ```ZeroYT7-Api```
-------
<h1 align="center">assalamu'alaikum <img src="https://user-images.githubusercontent.com/1303154/88677602-1635ba80-d120-11ea-84d8-d263ba5fc3c0.gif" width="40px" alt="hi"><br>I'm Zero YT7 😇 </h1>
<p align="center">
  <img src="https://i.ibb.co/5cFSGvJ/logo.jpg" /></>
</p>
...
## ```Connect with me```
<p align="center">
  <a href="https://instagram.com/Zero-YT7"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/> 
  ...
  <a href="https://github.com/Zero-YT7"><img src="https://img.shields.io/badge/-GitHub-black?style=flat-square&logo=github" /> 
  <a href="https://youtube.com/ZeroYT7"><img src="https://img.shields.io/youtube/channel/subscribers/UCdzWwbApjkyODby7_MoRYlA?style=social" /> <br>
...
case 'youtube_audio':  
      ...
      reply(lang.wait()) 
      anu = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/yutub/audio?url=${args[0]}&apikey=ZeroYT7`)
...
case 'hadist_sahih':
      ...
      kitab = get_args[0]
      nomor = get_args[1]
      var hadist = await fetchJson('https://zeroyt7-api.herokuapp.com/api/hadits?kitab=${kitab}&nomor=${nomor}&apikey=ZeroYT7')
...
case 'wallpaper_programming':
     get_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/wallpaper/teknologi?apikey=ZeroYT7`)
...
case 'random_quote':
     ini_result = await fetchJson('https://zeroyt7-api.herokuapp.com/api/randomquote?apikey=ZeroYT7')
...
case 'maker_2d':
      ...
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/maker?text=${teksnya}&apikey=ZeroYT7`}
      get_result = ini_result.result
...
case 'maker_3d':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} zeeoneofc)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/maker3d?text=${teksnya}&apikey=ZeroYT7`}
      get_result = ini_result.result
         ini_img = await getBuffer(get_result.results)
      alpha.sendMessage(from, ini_img, image,{quoted :mek, caption : 'Nih kak hasilnya'})
      break
...
case 'sertifikat_ff':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} zeeoneofc)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`zeroyt7-api.herokuapp.com/api/maker/special/epep?text=${teksnya}&apikey=ZeroYT7`}
      get_result = ini_result.result
         ini_img = await getBuffer(get_result.results)
      alpha.sendMessage(from, ini_img, image,{quoted :mek, caption : 'Nih kak hasilnya'})
      break
...
case 'coffe_cup':
      if (args.length < 1) return reply(`Usage: ${prefix + command} teks\nExample : ${prefix + command} zeeoneofc)
      teksnya = args.join(" ")
      ini_result = await fetchJson(`https://percobaannih.herokuapp.com/api/textmaker/senja?text=${teksnya}&theme=coffee-cup&apikey=ZeroYT7`}
      get_result = ini_result.result
...
case 'manga':
      ...
      query = args.join(" ")
      var manga = await fetchJson('https://percobaannih.herokuapp.com/api/anime/kusonime?search=${query}&apikey=ZeroYT7')
...
case 'asupan_santuy':
     ini_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/santuy?apikey=ZeroYT7`)
     get_result = ini_result.result
...
case 'nsfw_ass':
     ini_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/nsfw/ass?apikey=ZeroYT7`)
     get_result = ini_result.result
...
case 'cari_film':
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/filmapik/search?film=${query}&apikey=ZeroYT7`)
      for (var x = 0; x <= 1; x++) {
...
case 'lk21_tahun': //mencari film lk21 berdasarkan tahun
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/lk21/year?tahun=${query}&apikey=ZeroYT7`)
      for (var x = 0; x <= 1; x++) {
...
case 'republika': 
      ...
      query = args.join(" ")
      get_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/news/republika?type=${query}&apikey=ZeroYT7`)
      for (var x = 0; x <= 1; x++) {
         ini_txt = `DATA BERHASIL DI TEMUKAN\n\n`
...
case 'base64encode':
      if (args.length < 1) return reply(`Usage : ${prefix + command} teks\nExample : ${prefix + command} zeeoneofc)
      query = args.join(" ")
      ini_result = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/base?apikey=ZeroYT7&type=base64&encode=${query}`)
      get_result = ini_result.result
...
case 'covid_word':
     ini_result = await fetchJson('https://zeroyt7-api.herokuapp.com/api/covidworld?apikey=ZeroYT7')
     get_result = ini_result.result
